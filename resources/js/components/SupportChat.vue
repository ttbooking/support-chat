<template>
    <vue-advanced-chat
        ...
        :show-search="$env.features.show_search"
        :show-add-room="$env.features.show_add_room"
        :show-send-icon="$env.features.show_send_icon"
        :show-files="$env.features.show_files"
        :show-audio="$env.features.show_audio"
        :audio-bit-rate="$env.features.audio_bit_rate"
        :audio-sample-rate="$env.features.audio_sample_rate"
        :show-emojis="$env.features.show_emojis"
