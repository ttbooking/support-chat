<template>
    <vue-advanced-chat
        ...
        :show-search="$env.features.showSearch"
        :show-add-room="$env.features.showAddRoom"
        :show-send-icon="$env.features.showSendIcon"
        :show-files="$env.features.showFiles"
        :show-audio="$env.features.showAudio"
        :audio-bit-rate="$env.features.audioBitRate"
        :audio-sample-rate="$env.features.audioSampleRate"
        :show-emojis="$env.features.showEmojis"
        :show-reaction-emojis="$env.features.showReactionEmojis"
        :show-new-messages-divider="$env.features.showNewMessagesDivider"
        :show-footer="$env.features.showFooter"
        :styles.prop="style"
